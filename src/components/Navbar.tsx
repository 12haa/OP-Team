const Navbar = () => {
    return (
        <div
            className="bg-white  flex justify-between items-center rounded-2xl overflow-auto w-full h-full   shadow-gray-500 border-2 z-[99]  overflow-hidden ">
            <div
                ...
                <img src="/assets/Vector.png" className="w-4 h-6 ml-4 mt-1" alt="logout_button"/>
            </div>
